...
import { statementv10 } from "../../../src/chapter01/phase03final/statementFinalized.js";
import { htmlStatement } from "../../../src/chapter01/phase03final/statementFinalized";
...
describe("statement", () => {
  ...
  it("should print a statement for multiple plays, single customer and multiple seats in plain text", () => {
    ...
    expect(statementv10(invoicesJson[0])).to.equal(expected);
  });
  ...
  it("should print a statement for multiple plays, single customer and multiple seats in html", () => {
    ...
    expect(htmlStatement(invoicesJson[0])).to.equal(result);
  });
});
